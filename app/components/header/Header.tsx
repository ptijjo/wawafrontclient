...
const Header = () => {
  ...
  return (
    <header className='flex w-full items-center justify-between px-4 sm:px-6 bg-[#0A0A0A] text-[#D4AF37] h-16 fixed top-0 z-50'>
      <div className="max-w-7xl mx-auto flex w-full items-center justify-between">
        <div className="text-base sm:text-lg font-semibold">WavaBANGS</div>
        ...
        <Menubar className='md:hidden'>
          <MenubarMenu>
            <MenubarTrigger><GiHamburgerMenu className="size-5" /></MenubarTrigger>
